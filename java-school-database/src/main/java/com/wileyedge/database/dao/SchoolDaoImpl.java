...
public class SchoolDaoImpl implements SchoolDao {
    ...
    * Do not change any code outside of the placeholders provided.
    ...
    public List<StudentClassCount> studentsPerClass() {
        ...
        String sql = "SELECT course.courseCode, course.courseDesc, COUNT(*) as numStudents"
        		+ " FROM course INNER JOIN course_student ON course.cid=course_student.course_id"
    ...
    public void addStudentToClass() {
        ...
        String sql = "INSERT INTO course_student (student_id, course_id) "
        		...
        		+ "WHERE student.fName='Robert' AND student.lName='Dylan' AND course.courseCode='CS148'";
